		...
		<>
			<section className="footer">
					...
					<div className="row">
						<div className="col-xl-7 col-lg-7 wow fadeIn">
							<h2 className="fntitle">
								Terimakasih telah berkunjung ke <br />
								website{" "}
								<span style={{ color: "#0d5ff9" }}>
									OSISPENSA
								</span>
							</h2>
						</div>
							...
							<div className="single-footer">
								<div className="about-footer">
									...
									<div className="fot-social">
										...
										<ul>
											<li>
												<a href="https://id.wikipedia.org/wiki/SMP_Negeri_1_Purworejo">
													<i className="bx bxl-wikipedia"></i>
												</a>
											</li>

											<li>
												<a href="https://instagram.com/osispensa">
													<i className="bx bxl-instagram"></i>
												</a>
											</li>
											<li>
												<a href="https://www.youtube.com/@smp1Pwj">
						...
						<div className="col-xl-3 col-md-6 col-12 wow fadeIn">
							<div className="single-footer">
								...
								<ul>
									...
									<li>
										<a href="https://elements.envato.com/edumon-education-next-js-template-7L82M29">
											Edumon Template
										</a>
									</li>
								</ul>
				...
				<div className="copyright text-center wow fadeIn">
					<p>
						Copyright © 2024 <a href="/">OSISPENSA</a>. All rights
						reserved.
					</p>
				</div>
			</section>
