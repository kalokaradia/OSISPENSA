				...
				<div className="container">
						...
						<div className="col-xl-8 col-lg-7 col-md-12">
							<div className="banner-content d-flex align-items-center">
								<div className="banner-content-inner">
									<span className="subtitle">osispensa</span>
									<h2 className="title">
										<span>Welcome </span>to the{" "}
										<span className="text-light d-block">
											<span className="">OSISPENSA</span>{" "}
											Website
										</span>
									</h2>
									<p>
										At OSISPENSA, we believe in the power of
										unity,
										<br />
										where each individual contributes to the
					...
					<div className="banner_img">
						<div className="banner_img_inner moeffect">
							...
							/>
							<div
								className="total_students_badge eitem"
								defaultValue="1"
							>
								<div className="icon">
